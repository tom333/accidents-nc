...
def test_assets_defined():
    ...
    try:
        from dagster_pipeline.definitions import all_assets
...
def main():
    ...
    if passed == total:
        ...
        print("      PYTHONPATH=$PWD dagster dev -f dagster_pipeline/definitions.py")
